...
if(__name__ == '__main__'):
    print('QQQ')
    dataset = itemDataset( file_name='./../../data/test_data/test_data/SemEval2017-task3-English-test-input.xml',vocab='./vocab',task='taskA',transform=transforms.Compose([ToTensor()]))
